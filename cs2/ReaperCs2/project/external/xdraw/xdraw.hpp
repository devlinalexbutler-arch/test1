...
namespace tokens {
	...
	// Paid-menu language: Neverlose navy + Nixware blue
	inline xdraw::color col_accent{ 59, 130, 246, 255 };
	inline xdraw::color col_dark{ 12, 14, 20, 255 };
	inline xdraw::color col_text{ 236, 240, 248, 235 };
	inline xdraw::color col_text_dim{ 130, 140, 160, 200 };
	inline xdraw::color col_card{ 22, 26, 36, 230 };
	inline xdraw::color col_elevated{ 16, 18, 26, 240 };
	inline xdraw::color col_border{ 40, 48, 64, 120 };

	constexpr auto sidebar_w{ 176.0f };
	constexpr auto tab_icon_size{ 16.0f };
	constexpr auto subtab_bar_h{ 44.0f };
