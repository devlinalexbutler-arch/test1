...
namespace xui {
	...
	namespace {
			...
			float alpha_mult = 1.0f )
		{
			...
			auto border = st.checkbox_border.a ? st.checkbox_border : st.checkbox_mark;
			border.a = static_cast< std::uint8_t >( std::max< int >( 50, border.a ) * alpha_mult );
			dl.rect( x, y, size, size, border, xdraw::corner_radius{ st.checkbox_rounding }, 1.0f );
