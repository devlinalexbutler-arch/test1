...
namespace patterns {
	...
	const ::protection::addresses::address_t& action_matchmaking = ADDRESS_IMPL(
		::protection::addresses::hash("client.dll:48895C24??555741564881EC????????488B0D"),
		::protection::addresses::address_type::pattern,
		"client.dll:48895C24??555741564881EC????????488B0D");
