...
namespace rendering {
    ...
    private:
        ...
        int m_tab{};
        int m_subtab{};
		int m_content_transition_key{ -1 };
		float m_content_transition{ 1.0f };
	...
	public:
		void draw( );
		void notify( std::string title, std::string message, float duration = 4.0f );
	...
	private:
		...
		void notifications( xdraw::draw_list& draw_list );
