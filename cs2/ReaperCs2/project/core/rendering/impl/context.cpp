...
namespace rendering {
	...
	bool context::initialize( IDXGISwapChain* swap_chain )
	{
		...
		SetTimer( this->m_window,
			static_cast< UINT_PTR >( features::misc::auto_accept_timer_id ), 750, nullptr );
	...
	void context::shutdown( )
	{
		if ( this->m_window )
		{
			KillTimer( this->m_window,
				static_cast< UINT_PTR >( features::misc::auto_accept_timer_id ) );
		}
