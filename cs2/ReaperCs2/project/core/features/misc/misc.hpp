...
namespace features::misc {
	inline constexpr std::uintptr_t auto_accept_timer_id = 0x4B525950u;
	...
	private:
		...
		mutable float m_original_fov_sensitivity{ -1.0f };
		mutable std::uintptr_t m_fov_sensitivity_pawn{};
		mutable bool m_fov_sensitivity_overridden{};
		...
		struct player_weapon_state {
			...
			bool operator==(const player_weapon_state& o) const {
				return weapons == o.weapons && active_name == o.active_name &&
					kryptik == o.kryptik && agent == o.agent && skin_count == o.skin_count;
			}
		};
