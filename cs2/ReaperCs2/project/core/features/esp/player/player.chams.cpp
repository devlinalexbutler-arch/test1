...
namespace features::esp::player {
	...
	bool chams::on_generate_primitives( std::uintptr_t owner_entity, std::uint32_t owner_hash, std::uintptr_t scene_object, std::uintptr_t primitive_buffer, void( __fastcall* original_fn )( std::uintptr_t, std::uintptr_t, std::uintptr_t, std::uintptr_t ), std::uintptr_t a1, std::uintptr_t scene_view )
	{
		...
		const auto to_ignorez = [ ]( settings::esp::cham_ids id ) -> settings::esp::cham_ids
			{
				using id_t = settings::esp::cham_ids;
				switch ( id )
				{
				case id_t::liquid: return id_t::liquid_ignorez;
				case id_t::matte: return id_t::matte_ignorez;
				case id_t::flat: return id_t::flat_ignorez;
				case id_t::bloom: return id_t::bloom_ignorez;
				case id_t::outlines: return id_t::outlines_ignorez;
				case id_t::glow: return id_t::glow_ignorez;
				case id_t::distortion: return id_t::distortion_ignorez;
				case id_t::hologram: return id_t::hologram_ignorez;
				case id_t::metallic: return id_t::flat_ignorez;
				case id_t::electric: return id_t::glow_ignorez;
				case id_t::pearl: return id_t::matte_ignorez;
				default: return id;
				}
			};
		...
		const auto apply_config = [ & ]( const settings::esp::chams_config& cfg, std::uintptr_t target_scene_obj, bool force_original = false )
			{
				...
				{
					this->apply_layer( primitive_buffer, original_fn, a1, target_scene_obj, scene_view, cfg.secondary.color, to_ignorez( cfg.secondary.material ) );
				}
