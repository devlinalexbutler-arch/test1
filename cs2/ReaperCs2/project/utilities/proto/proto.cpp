...
namespace proto {
	namespace {
		template <typename T>
		T* mutable_existing_message( void* raw_message, has_bits& bits, std::uint32_t mask )
		{
			auto* message = impl_ptr<T>( raw_message );
			if ( message )
			{
				bits.set( mask );
			}
	...
	in_button_state_pb* base_usercmd_pb::mutable_buttons_pb( ) { return mutable_existing_message<in_button_state_pb>( this->m_buttons_pb, this->m_has_bits, 0x2u ); }
	...
	msg_qangle* base_usercmd_pb::mutable_viewangles( ) { return mutable_existing_message<msg_qangle>( this->m_viewangles, this->m_has_bits, 0x4u ); }
	...
	msg_qangle* input_history_entry::mutable_view_angles( ) { return mutable_existing_message<msg_qangle>( this->m_view_angles, this->m_has_bits, 0x1u ); }
	...
	interpolation_info_cl* input_history_entry::mutable_cl_interp( ) { return mutable_existing_message<interpolation_info_cl>( this->m_cl_interp, this->m_has_bits, 0x2u ); }
	...
	interpolation_info* input_history_entry::mutable_sv_interp0( ) { return mutable_existing_message<interpolation_info>( this->m_sv_interp0, this->m_has_bits, 0x4u ); }
	...
	interpolation_info* input_history_entry::mutable_sv_interp1( ) { return mutable_existing_message<interpolation_info>( this->m_sv_interp1, this->m_has_bits, 0x8u ); }
	...
	interpolation_info* input_history_entry::mutable_player_interp( ) { return mutable_existing_message<interpolation_info>( this->m_player_interp, this->m_has_bits, 0x10u ); }
	...
	msg_vector* input_history_entry::mutable_shoot_position( ) { return mutable_existing_message<msg_vector>( this->m_shoot_position, this->m_has_bits, 0x20u ); }
	...
	msg_vector* input_history_entry::mutable_target_head_pos_check( ) { return mutable_existing_message<msg_vector>( this->m_target_head_pos_check, this->m_has_bits, 0x40u ); }
	...
	msg_vector* input_history_entry::mutable_target_abs_pos_check( ) { return mutable_existing_message<msg_vector>( this->m_target_abs_pos_check, this->m_has_bits, 0x80u ); }
	...
	msg_qangle* input_history_entry::mutable_target_abs_ang_check( ) { return mutable_existing_message<msg_qangle>( this->m_target_abs_ang_check, this->m_has_bits, 0x100u ); }
	...
	base_usercmd_pb* csgo_usercmd_pb::mutable_base( ) { return mutable_existing_message<base_usercmd_pb>( this->m_base, this->m_has_bits, 0x1u ); }
